  ...
  projects: [
    {
      ...
      active: true,
      description:
        "A full-stack e-commerce platform with separate web, admin, and mobile apps , featuring dynamic product creation , coupon systems , and real-time inventory with role-based access , and is integrated with Razorpay and Shiprocket while being optimized to reduce checkout latency to 1.5s and improve conversion rates by 18%",
      technologies: [
        "Next.js",
        "Typescript",
        "Hono",
    ...
    {
      title: "Lately",
      href: "https://lately-web.vercel.app",
      dates: "May 2025 - September 2025",
      active: true,
      description:
        "A cross-platform gamified news media platform for web, Android, and iOS , featuring engagement systems like badges, boosts, and rewards , tiered subscription management via Dodo Payments , and is optimized with Redis caching to support over 1,000 concurrent users and deliver news in under 3 seconds.",
      technologies: [
        "Typescript",
        "Tanstack Router",
        "Expo",
      ...
      image: "https://utfs.io/f/zPjnl6p73EdY1cSIDMxCTk9O0SJrX2PD3hWcsmqBLnuKlFEd",
      video: "",
    },
    {
      title: "Echo Interview",
      href: "https://echo-interview.vercel.app",
      dates: "August 2025",
      active: true,
      description:
        "An AI-powered interview platform with a real-time, conversational agent that is context-aware of video and screen-sharing , provides AI-driven performance scoring across 5 skill dimensions , and enables end-to-end sessions with less than 200ms of latency using Stream.io.",
      technologies: [
        "Next.js",
        "Typescript",
        "Trpc",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/krishkalaria12/echo-interview",
